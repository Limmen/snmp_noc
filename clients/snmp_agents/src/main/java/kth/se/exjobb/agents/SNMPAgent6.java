...
public class SNMPAgent6 extends BaseAgent {
    private final UdpAddress host_address;
    private final UdpAddress target_address;
    
    public SNMPAgent6(String target, String host) throws IOException {
    ...
    public SNMPAgent6() throws IOException {
        ...
        this.host_address = new UdpAddress("127.0.0.1/9996");
    }
    ...
    public void sendSnmpV2Trap() {
        try {
            ...
            pdu.add(new VariableBinding(SnmpConstants.sysName, new OctetString("SIMULATED SNMP AGENT - NUMBER SIX")));
            pdu.add(new VariableBinding(SnmpConstants.sysDescr, new OctetString("SNMP AGENT NUMBER SIX")));
            pdu.add(new VariableBinding(new OID(".3.6.1.4.1.94.1.16.1.2.2.1.1.7"), new OctetString("Cleared")));
