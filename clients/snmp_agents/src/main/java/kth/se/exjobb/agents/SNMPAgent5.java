...
public class SNMPAgent5 extends BaseAgent {
    private final UdpAddress host_address;
    private final UdpAddress target_address;
    
    public SNMPAgent5(String target, String host) throws IOException {
    ...
    public SNMPAgent5() throws IOException {
        ...
        this.host_address = new UdpAddress("127.0.0.1/9995");
    }
    ...
    public void sendSnmpV2Trap() {
        try {
            ...
            pdu.add(new VariableBinding(SnmpConstants.sysName, new OctetString("SIMULATED SNMP AGENT - NUMBER FIVE")));
            pdu.add(new VariableBinding(SnmpConstants.sysDescr, new OctetString("SNMP AGENT NUMBER FIVE")));
            pdu.add(new VariableBinding(new OID(".3.6.1.4.1.94.1.16.1.2.2.1.1.7"), new OctetString("Indeterminate")));
